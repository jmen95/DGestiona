...
$(document).ready(function(){
  ...
  $('#radicado_form').submit(function(e){
    ...
    $.ajax({
      type : "GET",
      url : "http://192.168.0.6:8080/gestiondocumental/Consulta",
...
$(document).on("pagecreate", "#radicadoS", function() {
  ...
  //select dinamicos radicado SALIDA
    $("#pais_per_s").change(function(){
      $.ajax({
        type : "GET",
        url : "http://192.168.0.6:8080/gestiondocumental/SelectDinamico",
...
$(document).on("pagecreate", "#radicadoE", function() {
  ...
  $.ajax({
    type : "GET",
    url : "http://192.168.0.6:8080/gestiondocumental/SelectPais",
    dataType: 'json',
    contentType: 'application/json',
    xhrFields: {
      withCredentials: false
  ...
  $.ajax({
      type : "GET",
      url : "http://192.168.0.6:8080/gestiondocumental/SelectDependencia",
      dataType: 'json',
      contentType: 'application/json',
      xhrFields: {
        withCredentials: false
  ...
  $.ajax({
      type : "GET",
      url : "http://192.168.0.6:8080/gestiondocumental/SelectTipoPersona",
      dataType: 'json',
      contentType: 'application/json',
      xhrFields: {
        withCredentials: false
  ...
  $.ajax({
      type : "GET",
      url : "http://192.168.0.6:8080/gestiondocumental/SelectTipoIdentificacion",
      dataType: 'json',
      contentType: 'application/json',
      xhrFields: {
        withCredentials: false
    ...
    $.ajax({
      type : "GET",
      url : "http://192.168.0.6:8080/gestiondocumental/SelectMedioRecepcion",
      dataType: 'json',
      contentType: 'application/json',
      xhrFields: {
        withCredentials: false
